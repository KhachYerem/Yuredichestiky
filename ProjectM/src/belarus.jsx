...
const generateRandomData = (count) => {
  const regions = ["Минская область", "Гомельская область", "Брестская область", "Витебская область"];
    ...
    <div className="entry-ban-container">
          ...
          <div className="collapse navbar-collapse" id="navbarText">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <p className="nav-item">
                <Link className="nav-link" to="/">Въезд в РФ</Link>
              </p>
              <p className="nav-item lili">
                <Link className="nav-link active nav-item-p2" aria-current="page" to="/belarus">Въезд в Беларусь</Link>
              </p>
            </ul>
      ...
      <section className="form-section">
        ...
        <h1 className="main-title">
          <span className="highlight">ПРОВЕРКА ЗАПРЕТА</span> НА ВЪЕЗД В БЕЛАРУСЬ
        </h1>
        ...
        <div className="info-block">
          <p>
            Согласно законодательству Республики Беларусь, каждый иностранный гражданин вправе въехать на территорию страны, за исключением ряда случаев.
            Для проверки каждого иностранного гражданина доступна онлайн проверка запрета въезда на территорию Республики Беларусь.
          </p>
        </div>
      </section>
      ...
      <section className="stats-section">
        <div className="stats-header">
          <h2>СТАТИСТИКА ПРОВЕРОК ЗАПРЕТА ВЪЕЗДА В БЕЛАРУСЬ</h2>
        </div>
      ...
      <div className="report-wrapper">
        <div className="report-container">
          ...
          <div className="report-text">
            <h2>ПРИМЕР СПРАВКИ “РАЗРЕШЕНИЕ НА ВЪЕЗД В БЕЛАРУСЬ”</h2>
            <p className="report-text-p">
              Пример сформированного отчета сервисом fsspru, в отчете отражено наличие ограничений на въезд, все данные являются вымышленными, любые совпадения с реальными людьми случайны.
            </p>
            <div className="report-result">
              ...
              <p className="report-text-p">Регион: Минская область</p>
              <p className="report-text-p">
                <a href="#" className="report-check-link">Въезд в Беларусь: Разрешен</a>
              </p>
            </div>
            <div className="report-result2">
              <p className="report-note">
                Согласно статистике – 65% граждан имеют запрет на въезд на территорию Республики Беларусь. Рекомендуем произвести проверку.
              </p>
      ...
      <div className="app-container2">
        <h1 className="main-title">
          <span className="highlight">КАК ПРОВЕРИТЬ</span> НА ВЪЕЗД НА ГРАНИЦУ БЕЛАРУСИ
        </h1>
        <p className="description">Для проверки ограничений на въезд в Беларусь отправьте онлайн заявку в базу данных.</p>
        <p className="description2">
          Если Вам потребуется справка для подтверждения возможности (разрешения) въезда на территорию Республики Беларусь, вы сможете получить ее на последнем шаге.
        </p>
        <p className="description2">
        ...
        <div className="app-container">
          ...
          <StepCard number="3" text="Дождитесь обработки данных, это займет не более 5 минут." />
        </div>
      </div>
